...
<Pagination :links="users.links" class="mt-6 space-x-2"/>
</template>
<script setup>
...
// import debounce from "lodash/debounce";
  ...
  let props = defineProps({
    ...
    watch(search , 
      // throttle will send  the request while typing each 500ms 
    throtlle(function (value){
      Inertia.get('/users' , {search: value},{  preserveState:true, replace:true }); }, 500)
      
      // debounce will send the request after 500ms when you done 
